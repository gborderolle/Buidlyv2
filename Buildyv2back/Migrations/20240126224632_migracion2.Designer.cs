...
namespace Buildyv2.Migrations
{
    ...
    [Migration("20240126224632_migracion2")]
            ...
            modelBuilder.Entity("Buildyv2.Models.BuildyRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 485, DateTimeKind.Local).AddTicks(6200),
                            Name = "Admin",
                            NormalizedName = "ADMIN",
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 485, DateTimeKind.Local).AddTicks(6200)
                        },
                        new
                        {
                            Id = "bef4cbd4-1f2b-472f-a3f2-e1a901f6811c",
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 485, DateTimeKind.Local).AddTicks(6205),
                            Name = "User",
                            NormalizedName = "USER",
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 485, DateTimeKind.Local).AddTicks(6205)
                        });
                });
            ...
            modelBuilder.Entity("Buildyv2.Models.BuildyUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "b783d2c7-1fb1-4b8a-b821-b95207799742",
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 485, DateTimeKind.Local).AddTicks(6214),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEM5uMc+7L05ufz0lFUcX1Rc9ptnMbaAbJ7+MGWHBxyCrmhleAB7tVRE+2GH2UWokSw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "af177ad6-5e45-4b42-828b-c9edcede984a",
                            TwoFactorEnabled = false,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 485, DateTimeKind.Local).AddTicks(6215),
                            UserName = "useradmin"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "f833f0c4-1d7b-42a1-b0c7-4e7d0088172e",
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 561, DateTimeKind.Local).AddTicks(737),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEM3kJJ6NYBtUdr0zMRFyYAixDyVSG3CyR8k1Ivvqgf1H5nz6T9Z+cXOz9XuvRom22w==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "6592f575-9834-4191-8ff9-4adbcf4e5f7c",
                            TwoFactorEnabled = false,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 561, DateTimeKind.Local).AddTicks(751),
                            UserName = "usernormal"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "d6ec23fa-421e-4725-992b-c191d442e93b",
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 636, DateTimeKind.Local).AddTicks(6652),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEN7SygZ7PwrYaTyJ6auQyx4Tbl9sTlBtRa7Y5AvqP09nVgWvIGI6aPnaGyXKO/9dGg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "d5ffd280-610c-4256-ba0a-2a2bb1f27c06",
                            TwoFactorEnabled = false,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 636, DateTimeKind.Local).AddTicks(6669),
                            UserName = "mirtadls"
                        },
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "22f6de7e-6efe-437b-9cb1-5e63aacfe55f",
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 711, DateTimeKind.Local).AddTicks(5879),
                            ...
                            PasswordHash = "AQAAAAIAAYagAAAAEJtXXVCPgRB/8D4tjTOIHt5wuM5P0Vw7KZMHfMXLn29QcdH5Hn+Cekd9U3ddA/rJiw==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "46a32c47-cb2b-4c39-ae02-3721aee10e4a",
                            TwoFactorEnabled = false,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 711, DateTimeKind.Local).AddTicks(5895),
                            UserName = "irgla"
                        });
                });
            ...
            modelBuilder.Entity("Buildyv2.Models.CityDS", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9195),
                            Name = "Melo",
                            NominatimCityCode = "ME",
                            ProvinceDSId = 1,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9196)
                        },
                        new
                        {
                            Id = 2,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9199),
                            Name = "Montevideo",
                            NominatimCityCode = "MO",
                            ProvinceDSId = 2,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9199)
                        });
                });
            ...
            modelBuilder.Entity("Buildyv2.Models.CountryDS", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9104),
                            Name = "Uruguay",
                            NominatimCountryCode = "UY",
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9109)
                        });
                });
            ...
            modelBuilder.Entity("Buildyv2.Models.Estate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Address = "Colón 476",
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9273),
                            ...
                            OwnerDSId = 3,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9274)
                        },
                        new
                        {
                            Id = 2,
                            Address = "Colón 480",
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9281),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 2,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9281)
                        },
                        new
                        {
                            Id = 3,
                            Address = "Colón 491",
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9284),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 2,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9284)
                        },
                        new
                        {
                            Id = 4,
                            Address = "Colón 495",
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9285),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 2,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9286)
                        },
                        new
                        {
                            Id = 5,
                            Address = "Colón 503",
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9287),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 2,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9287)
                        },
                        new
                        {
                            Id = 6,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9290),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9290)
                        },
                        new
                        {
                            Id = 7,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9291),
                            EstateIsRented = false,
                            GoogleMapsURL = "https://www.google.com/maps/place/Calle+Dr.+Juan+Dar%C3%ADo+Silva+774,+37000+Melo,+Departamento+de+Cerro+Largo/@-32.3679807,-54.1752022,17z/data=!3m1!4b1!4m6!3m5!1s0x95092980a2c60edb:0x48ad692931a026ea!8m2!3d-32.3679807!4d-54.1726219!16s%2Fg%2F11gr6dzf3g?hl=es-419&entry=ttu",
                            LatLong = "-32.3679807,-54.1752022",
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9292)
                        },
                        new
                        {
                            Id = 8,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9293),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9293)
                        },
                        new
                        {
                            Id = 9,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9295),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 2,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9296)
                        },
                        new
                        {
                            Id = 10,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9297),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9297)
                        },
                        new
                        {
                            Id = 11,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9298),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9299)
                        },
                        new
                        {
                            Id = 12,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9380),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9380)
                        },
                        new
                        {
                            Id = 13,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9382),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9382)
                        },
                        new
                        {
                            Id = 14,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9384),
                            EstateIsRented = false,
                            GoogleMapsURL = "https://www.google.com/maps/place/C.+Col%C3%B3n+476,+37000+Melo,+Departamento+de+Cerro+Largo/@-32.3674814,-54.1757085,17z/data=!3m1!4b1!4m6!3m5!1s0x95092980b6fbe707:0x3f99b6b98961385b!8m2!3d-32.3674814!4d-54.1731282!16s%2Fg%2F11fn9p0pws?hl=es-419&entry=ttu",
                            LatLong = "-32.3674814,-54.1757085",
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9384)
                        },
                        new
                        {
                            Id = 15,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9386),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9386)
                        },
                        new
                        {
                            Id = 16,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9387),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9387)
                        },
                        new
                        {
                            Id = 17,
                            ...
                            CityDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9389),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 2,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9389)
                        },
                        new
                        {
                            Id = 18,
                            ...
                            CityDSId = 2,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9391),
                            EstateIsRented = false,
                            ...
                            OwnerDSId = 1,
                            PresentRentId = 0,
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9391)
                        });
                });
            ...
            modelBuilder.Entity("Buildyv2.Models.OwnerDS", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Color = "violet",
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9238),
                            Name = "Mirta",
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9238)
                        },
                        new
                        {
                            Id = 2,
                            Color = "orange",
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9240),
                            Name = "Gladys",
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9240)
                        },
                        new
                        {
                            Id = 3,
                            Color = "green",
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9241),
                            Name = "Cristina",
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9242)
                        });
                });
            ...
            modelBuilder.Entity("Buildyv2.Models.ProvinceDS", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            CountryDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9156),
                            Name = "Cerro Largo",
                            NominatimProvinceCode = "CL",
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9157)
                        },
                        new
                        {
                            Id = 2,
                            CountryDSId = 1,
                            Creation = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9158),
                            Name = "Montevideo",
                            NominatimProvinceCode = "MO",
                            Update = new DateTime(2024, 1, 26, 19, 46, 31, 787, DateTimeKind.Local).AddTicks(9159)
                        });
                });
